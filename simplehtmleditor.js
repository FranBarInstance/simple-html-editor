...
(function () {
    ...
    window.ncSimpleHtmlEditor = function (options = {}) {
        ...
        const defaults = {
            ...
            additionalPrompts: {
                "only replacement": 'Iinstructions:\nProvide only what is requested, including all code or text in -IMPUT- that does not change, without additional comments, without Markdown. The div id ncsedt-implement code must never be modified.'
            },
